...
>>>>>>> bc5ecfb51c6e630b1c1005557317e84b6cc0b218
 *
...
exports.monitor = function(options) {
  ...
  if (!options.server) {
    // Create and use our own express server on the default port/host.
    var app = express();
...
function emitData() {
  ...
  //console.log("HTTP URLS " + JSON.stringify(httpURLData));
  if(Object.keys(httpURLData).length > 0) {
    ...
    //console.log("\n\n\n\nemitting " + JSON.stringify(result));
